...
export class CreateDeliverySLAMasterServiceApi extends Service<Input> {
  ...
  public async execute(input: Input): Promise<ServiceOutput> {
    ...
    const url = isUpdating && id
      ...
      : `${apiUrl}/delivery-sla-master?sessionId=${sessionId}`;
    ...
    const response = await fetch(url, {
      ...
      body: JSON.stringify({
        ...
        deliveryPeriodHours: deliveryPeriodHours !== "" ? deliveryPeriodHours : undefined,
