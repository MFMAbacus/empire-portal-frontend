...
export class DeletePropertyManagementApprovalMasterServiceMock extends Service<Input> {
  ...
  public async execute(input: Input): Promise<ServiceOutput> {
    console.log('delete property management approval master service', input);
