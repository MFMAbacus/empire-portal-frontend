...
type CreateEmailTemplateMasterProps = {
  sessionId: string;
  onBack: () => void;
};
...
export const CreateEmailTemplateMaster = ({
  sessionId,
  onBack,
}: CreateEmailTemplateMasterProps): JSX.Element => {
  ...
  return (
    <Dashboard.Content>
      <Actionbar title="CREATE EMAIL TEMPLATE MASTER">
        <Button
          label="SAVE"
      ...
      <Dashboard.Page>
        <Paper>
          ...
          <Paper.Title value="Email Template Details" />
          ...
          <Grid>
            <Grid.Cell size={Grid.CellSize.S4}>
              <TextInput
                ...
                value={templateCode}
                hasError={typeof validation["templateCode"] !== "undefined"}
