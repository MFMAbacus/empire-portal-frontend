...
type FilterModalProps = {
  defaultFilters: FacilityApprovalFilters;
  onFilter: (filters: FacilityApprovalFilters) => void;
  onClose: () => void;
};
...
export const FilterModal = ({
  ...
  const [filters, setFilters] = React.useState<FacilityApprovalFilters>(defaultFilters);

  return (
    <Modal>
      <Modal.Header title='Filter Facility Approval' />
      <Modal.Body>
