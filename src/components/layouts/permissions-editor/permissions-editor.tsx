...
const masterformsSubSections: PermissionItem[] = [
  ...
  { id: "guard-account-mapping-master", title: "Guard Account Mapping Master" },
  { id: "vehicle-type-master", title: "Vehicle Type Master" },
  { id: "qr-configuration-master", title: "QR Configuration" },
  { id: "security-coordinator-master", title: "Security Coordinator Mapping" },
