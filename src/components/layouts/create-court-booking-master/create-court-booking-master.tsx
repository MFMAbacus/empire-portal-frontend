...
type CreateCourtBookingMasterProps = {
  sessionId: string;
  onBack: () => void;
};
...
export const CreateCourtBookingMaster = ({
  sessionId,
  onBack,
}: CreateCourtBookingMasterProps): JSX.Element => {
  ...
  return (
    <Dashboard.Content>
      <Actionbar title="CREATE COURT BOOKING RULE">
        <Button
          label="SAVE"
      ...
      <Dashboard.Page>
        <Paper>
          ...
          <Paper.Title value="Court Booking Rule Master Details" />
