...
type CreateFacilityApprovalMasterProps = {
  sessionId: string;
  onBack: () => void;
};
...
export const CreateFacilityApprovalMaster = ({
  sessionId,
  onBack,
}: CreateFacilityApprovalMasterProps): JSX.Element => {
    ...
    <Dashboard.Content>
      ...
      <Actionbar title="FACILITY APPROVAL">
        <Button
          ...
          isDisabled={isLoading || !approverRole || !projectCode || isSuccess}
      ...
      <Dashboard.Page>
        <Paper>
          ...
          <Paper.Title value="Facility Approval Details" />
